...
class unblockadblocker_Sanitize {
    ...
    public function clean() {
         ...
         */
        do_action( 'unblockadblocker_pre_sanitize', $sanitized );
         ...
         */
        do_action( 'unblockadblocker_post_sanitize', $sanitized );
    ...
    public function set_type( $type ) {
        ...
        if ( empty( $type ) ) {
            ...
            $check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'unblockadblocker' ) );

        }

        if ( is_wp_error( $check ) ) {

            wp_die( $check->get_error_message(), __( 'Forgot data type', 'unblockadblocker' ) );
